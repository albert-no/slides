...
- **`talks/postech260819/`** — POSTECH Ok-lab seminar (2026-08-19, 50 min, graduate AI audience): "Small Interventions, Large Effects" — REFT first-token diversification, SafePath 8-token safety primer, few-shot Benign DPO attack (GPT fine-tuning-service framing + TenBenign prior art), 3-slide unlearning-position close; high-level connections to SEAG/LSC/FedVPA-GP; lab-author photos on section dividers; 2 lab-publication slides (papers in the talk + other records since 2025) before the closer. 42 slides (incl. 5 NeurIPS-2026 rebuttal slides for REFT and Benign DPO), figures captured from papers, no notes.
...
| REFT (first-token diversification for RLVR) | `talks/postech260819/postech260819.html:140-450` (rebuttal: 368-415) |
| SafePath (8-token safety primer for LRMs) | `talks/postech260819/postech260819.html:451-586` |
| Benign DPO attack + fine-tuning-as-a-service | `talks/postech260819/postech260819.html:587-820` (rebuttal: 691-768) |
