...
5. **Structural audit** — list candidates for upgrade against DESIGN_SYSTEM §2, each with a one-line rationale:
...
- Introduce new CSS classes — those belong in a `reference/deck.css` edit, documented per DESIGN_SYSTEM §12.
