...
\newcommand{\bNone}{{\bf N}^{(1)}}
\newcommand{\bNtone}{\tilde{\bf N}^{(1)}}
\newcommand{\bNtwo}{{\bf N}^{(2)}}
\newcommand{\bZone}{{\bf Z}^{(1)}}
\newcommand{\bZtwo}{{\bf Z}^{(2)}}
\newcommand{\bXhone}{\hat{\bf X}^{(1)}}
\newcommand{\bXhtwo}{\hat{\bf X}^{(2)}}
\newcommand{\bZtone}{\tilde{\bf Z}^{(1)}}
...
\newcommand{\Prob}[1]{\mathify{\mathbf{Pr}\left[#1\right]}}
\newcommand{\Puv}[1]{P_{U|V}\left[#1\right]}
\newcommand{\Pvu}[1]{P_{V|U}\left[#1\right]}
\newcommand{\Pu}[1]{P_U\left[#1\right]}
\newcommand{\Pv}[1]{P_V\left[#1\right]}
\newcommand{\Pbuv}[1]{P_{\bU|\bV}\left[#1\right]}
\newcommand{\Pbvu}[1]{P_{\bV|\bU}\left[#1\right]}
\newcommand{\Pbu}[1]{P_\bU\left[#1\right]}
\newcommand{\Pbv}[1]{P_\bV\left[#1\right]}
...
\newcommand{\privunit}{\mbox{PrivUnit}}
\newcommand{\dptopk}{\mbox{DP-Top-$k$}}
