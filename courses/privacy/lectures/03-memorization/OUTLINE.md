...
- **Diffusion preliminaries** at `memorization-diffusion.html:195` reuse score-based notation from `privacy/lectures/02-generative/diffusion3-sde-score.html`. No re-derivation here — pointer only.
