...
- **`talks/researchintro2609/`** — "Finding a Research Project" seminar (Sep 2026, first-year graduate students with no research experience, currently taking LLM/agent/RL courses): the project-is-a-new-artwork analogy carried through five sections — what a project is not (single-prompt / existing-repo / swapped-dataset / rerun tests), survey as art history, nontriviality and the two-day test, justification as a museum wall label, and a four-week working habit. 58 slides, ~21 inline SVG exhibits, no captured figures, no notes.
...
| How to find a research project topic (project-as-artwork analogy) | `talks/researchintro2609/researchintro2609.html` |
