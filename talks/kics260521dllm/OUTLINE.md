...
None. All material on slide. For deeper diffusion theory, see `infotheory/lectures/07-diffusion/` (VAE/ELBO derivations, parameterizations) and `privacy/lectures/02-generative/` (Bayes-route, SDE, score-matching theorem, discrete diffusion).
